...
const h2Vinos=document.createElement("h2");
    h2Vinos.innerText="Los mejores vinos del país los encontrás acá";
...
const h3Final=document.createElement("h3");
    ...
    h3Final.style.marginTop="1rem"
    h3Final.style.marginRight="45rem";
    h3Final.style.textAlign="center";
    h3Final.innerText="Explorá nuestra sección de productos y descubrí nuevos sabores.";
...
h1.innerText="Bienvenido a la vinoteca";
...
div.appendChild(h1);
parrafoInicio.innerText="Te invitamos a conocer nuestra sección de productos";
...
parrafoEnFotos2.innerText="Más de 400 sucursales distribuidas en nuestro país.";
